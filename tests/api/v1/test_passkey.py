...
def mock_db_session():
    ...
    with patch("camp44.api.deps_async.get_db") as mock_get_db:
...
def auth_headers():
    ...
    with patch("camp44.api.deps_async.get_current_active_user") as mock_get_user:
        user_id = uuid.uuid4()
        mock_user = MagicMock()
...
@patch("camp44.crud.user_async.update")
...
@patch("camp44.crud.user_async.get_by_email")
