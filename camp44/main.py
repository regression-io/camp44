...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "https://app.scalemate.me",
        "https://gtm.scalemate.me",
        "https://scalemate.me",
        "http://localhost:5173",
        "http://localhost:3000",
    ],
...
app.include_router(
    integrations.router, prefix="/apps/{app_id}/integrations", tags=["integrations"]
)
...
app.include_router(
    entities.router, prefix="/api/apps/{app_id}/entities", tags=["entities"]
)
app.include_router(bulk.router, prefix="/api/apps/{app_id}/bulk", tags=["bulk"])
app.include_router(
    integrations.router, prefix="/api/apps/{app_id}/integrations", tags=["integrations"]
)
